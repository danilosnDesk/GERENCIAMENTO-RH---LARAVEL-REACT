        ...
        <div className="py-4 px-8">
            ...
            {!Errors && !Loading && funcionario &&
                <div className="flex gap-4">
                    <div className="relative shadow-2xl p-4 w-1/4 flex flex-col items-center gap-2 bg-violet-50">
                        ...
                        <div className="text-center">
                            <h4 className="text-[#2c384e] text-[20px] ">{funcionario.nome}</h4>
                    ...
                    <div className="shadow-2xl relative flex-1 ">
                        ...
                        <ul className="bg-white w-full flex gap-2 border-b-2 border-slate-200 transition-all">
                            <li className={`transition cursor-pointer py-4 px-8 text-gray-700 ${ActiveTab === Tabs[0] ? 'border-b-4 border-violet-500 text-violet-500' : 'hover:border-b-4 hover:border-violet-500'}`} onClick={() => { setActiveTab(Tabs[0]) }}>Ficha técnica</li>
                            <li className={`transition cursor-pointer py-4 px-8 text-gray-700 ${ActiveTab === Tabs[1] ? 'border-b-4 border-violet-500 text-violet-500' : 'hover:border-b-4 hover:border-violet-500'}`} onClick={() => { setActiveTab(Tabs[1]) }}>Editar Perfil</li>
                        </ul>
                        {displayData()}
                    </div>
                </div >
